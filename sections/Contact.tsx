...
${formData.message}`
    ...
    window.location.href = `mailto:louissedominiquebertillo@gmail.com?subject=${subject}&body=${body}`;
    setIsSubmitting(false);
  };
        ...
        >
          ...
          <motion.div variants={itemVariants} className="mb-12">
            <Body className="text-xl md:text-2xl text-neutral-300 max-w-2xl">
              Book a free consultation and share your project scope. I will recommend the best package,
              timeline, and implementation plan based on your goals.
            </Body>
          </motion.div>
          ...
          >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <label className="text-sm text-neutral-400">
                ...
                <input
                  ...
                  className="mt-2 w-full rounded-lg border border-neutral-800 bg-neutral-900 px-3 py-2 text-white focus:outline-none focus:border-neutral-600"
                />
              </label>
              <label className="text-sm text-neutral-400">
                Email
            ...
            <div className="mt-6 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
              ...
              <button
                ...
                className="inline-flex items-center justify-center rounded-full bg-white text-black px-6 py-3 text-sm font-medium hover:bg-neutral-200 transition-colors"
              >
                {isSubmitting ? 'Sending...' : 'Book Free Consultation'}
              </button>
            </div>
            {submitFeedback && (
              <p className="mt-3 text-xs text-emerald-400">{submitFeedback}</p>
            )}
          </motion.form>
          ...
          <motion.div variants={itemVariants} className="mb-12 rounded-2xl border border-neutral-800 bg-neutral-950/30 p-6 md:p-8">
            ...
            <div className="space-y-4 text-sm">
              <div>
                ...
                <p className="text-neutral-400">Most projects start within 2-5 days after confirmation and initial payment.</p>
              </div>
              <div>
